...
public class MapRouterDialog {
    ...
    public MapRouterDialog(Activity activity, Bundle bundle,GoogleMap googleMap) {
    ...
    private void init() {
        ...
        Geocoder geo = new Geocoder(activity, Locale.TRADITIONAL_CHINESE);
        ...
        if (addrList == null || addrList.isEmpty()) {
            Toast.makeText(activity, activity.getResources().getString(R.string.nonLatLng), Toast.LENGTH_SHORT).show();
