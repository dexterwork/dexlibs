...
import com.demondevelopers.example.crashreporting.ReportFilesProvider;
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		*/
        ...
        target.putExtra(Intent.EXTRA_EMAIL, new String[]{
                stu.dex.report.ReportHandler.getEmailAddress()
        });
        ...
        if (screenshot != null) {
            attachments.add(stu.dex.report.ReportFilesProvider.setFilePath(
                    stu.dex.report.ReportFilesProvider.FILE_INDEX_SCREENSHOT, screenshot));
        }

        String eventLogPath = stu.dex.report.ReportHandler.saveEventLog();
        if (eventLogPath != null) {
            attachments.add(stu.dex.report.ReportFilesProvider.setFilePath(
                    stu.dex.report.ReportFilesProvider.FILE_INDEX_EVENTLOG, eventLogPath));
        }

        String systemLogPath = stu.dex.report.ReportHandler.saveSystemLog();
        if (systemLogPath != null) {
            attachments.add(stu.dex.report.ReportFilesProvider.setFilePath(
                    stu.dex.report.ReportFilesProvider.FILE_INDEX_SYSTEMLOG, systemLogPath));
        }
