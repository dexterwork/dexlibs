...
import com.demondevelopers.example.crashreporting.*;
import com.demondevelopers.example.crashreporting.ReportActivity;
import com.demondevelopers.example.crashreporting.ReportingActivity;
    ...
    private static class UncaughtHandler implements UncaughtExceptionHandler {
        public void uncaughtException(Thread thread, Throwable ex) {
            try {
                ...
                if (bm != null) {
                    screenshot = com.demondevelopers.example.crashreporting.ReportHandler.saveScreenShot(bm);
                    bm.recycle();
                }
